export const BRAND_ASSET_PATHS = {
  ...
  nightlyIosIconPng: "assets/d3code/d3code-universal-1024.png",
  nightlyMacIconPng: "assets/d3code/d3code-macos-1024.png",
  nightlyLinuxIconPng: "assets/d3code/d3code-universal-1024.png",
  nightlyWindowsIconIco: "assets/d3code/d3code-windows.ico",
  nightlyWebFaviconIco: "assets/d3code/d3code-web-favicon.ico",
  nightlyWebFavicon16Png: "assets/d3code/d3code-web-favicon-16x16.png",
  nightlyWebFavicon32Png: "assets/d3code/d3code-web-favicon-32x32.png",
  nightlyWebAppleTouchIconPng: "assets/d3code/d3code-web-apple-touch-180.png",
