...
it.layer(NodeServices.layer)("build-desktop-artifact", (it) => {
  ...
  it("switches desktop packaging product names to nightly for nightly builds", () => {
    ...
    assert.equal(resolveDesktopProductName("0.0.17-nightly.20260413.42"), "D3 Code");
  });
  ...
  it("normalizes explicit macOS passkey RP domains and renders required entitlements", () => {
    ...
    assert.include(entitlements, "<string>ABC1234567.com.diegojohnson.d3code</string>");
  ...
  it.effect("adds passkey entitlements and both renderer protocols to signed macOS builds", () =>
    Effect.gen(function* () {
      ...
      assert.equal(config.appId, "com.diegojohnson.d3code");
  ...
  it.effect("resolves default platform and architecture from host references", () =>
    Effect.gen(function* () {
      ...
      assert.equal(resolved.macPasskeySigning, true);
    }),
  );
  ...
  it.effect("preserves explicit false boolean flags over true env defaults", () =>
    Effect.gen(function* () {
          ...
          ConfigProvider.layer(
            ConfigProvider.fromEnv({
              env: {
                ...
                T3CODE_MACOS_PASSKEY_SIGNING: "false",
      ...
      assert.equal(resolved.macPasskeySigning, false);
