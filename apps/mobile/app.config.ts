...
const PREVIEW_ASSETS = {
  ...
  androidAdaptiveForeground: "./assets/android-icon-foreground-empty.png",
  androidAdaptiveBackgroundColor: "#181838",
  androidAdaptiveBackgroundImage: "./assets/android-icon-background-d3code.png",
  androidSplashIcon: "./assets/android-splash-icon-d3code.png",
  androidMonochromeIcon: "./assets/android-icon-mark.png",
  androidNotificationIcon: "./assets/android-notification-icon.png",
