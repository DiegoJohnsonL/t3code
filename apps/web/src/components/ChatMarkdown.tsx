...
function CodexArtifactTemplateCard(props: {
  ...
  return (
    <div
      ...
      className="surface-glass my-[0.65rem] flex w-full min-w-0 items-center gap-3 rounded-xl border border-border/70 px-3 py-2.5 text-foreground shadow-xs"
...
function MarkdownCodeBlock({
  ...
  return (
    <div
      className="chat-markdown-codeblock my-[0.65rem] overflow-hidden rounded-lg border border-border/70 leading-snug"
